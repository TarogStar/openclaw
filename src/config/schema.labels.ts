...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "tools.email.enabled": "Enable Email Tool",
  "tools.email.provider": "Email Provider",
  "tools.email.timeoutSeconds": "Email Timeout (sec)",
  "tools.email.cacheTtlMinutes": "Email Cache TTL (min)",
  "tools.calendar.enabled": "Enable Calendar Tool",
  "tools.calendar.provider": "Calendar Provider",
  "tools.calendar.timeoutSeconds": "Calendar Timeout (sec)",
  ...
  "channels.msteams.execApprovals": "Exec Approvals",
  "channels.msteams.execApprovals.enabled": "Enable Exec Approvals",
